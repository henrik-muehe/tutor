...
class AssessmentsControllerTest < ActionController::TestCase
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post :create, assessment: { remark: @assessment.remark, student_id: @assessment.student_id, user_id: @assessment.user_id, value: @assessment.value, week: @assessment.week }
    end
  ...
  test "should update assessment" do
    patch :update, id: @assessment, assessment: { remark: @assessment.remark, student_id: @assessment.student_id, user_id: @assessment.user_id, value: @assessment.value, week: @assessment.week }
    assert_redirected_to assessment_path(assigns(:assessment))
  end
